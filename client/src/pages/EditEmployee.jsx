...
import { ArrowLeft, Save, User, Briefcase, DollarSign, Loader2 } from 'lucide-react';
...
const EditEmployee = () => {
    ...
    if (loading) return <div className="flex items-center justify-center p-20 text-indigo-400"><Loader2 className="animate-spin" size={32} /></div>;
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <header className="flex justify-between items-center">
                <div>
                    ...
                    <h2 className="text-3xl font-black text-white tracking-tight">Edit Employee</h2>
                </div>
            </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                {...register('employeeId')}
                                className="w-full bg-slate-800/50 border border-slate-700 focus:border-indigo-500 rounded-xl py-3 px-4 text-white outline-none transition-all font-mono"
                            />
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                {...register('position')}
                                className="w-full bg-slate-800/50 border border-slate-700 focus:border-indigo-500 rounded-xl py-3 px-4 text-white outline-none transition-all"
                            />
